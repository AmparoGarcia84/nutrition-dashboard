...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      ghost: 'text-muted hover:text-foreground hover:bg-muted-light focus:ring-muted',
      danger: 'bg-danger text-white hover:bg-danger/90 focus:ring-danger shadow-lg shadow-danger/25',
    };
